...
export class ReceiptDetector {
  static isReceipt(email) {
    ...
    const hasReceiptKeywords = CONFIG.RECEIPT_KEYWORDS.some(
  ...
  static categorizeReceipt(email) {
    ...
    if (from.includes("doordash") || from.includes("grubhub"))
      return "food-delivery";
    if (from.includes("starbucks") || from.includes("mcdonalds"))
      return "restaurants";
    if (
      ...
      return "retail";
    if (from.includes("netflix") || from.includes("spotify"))
