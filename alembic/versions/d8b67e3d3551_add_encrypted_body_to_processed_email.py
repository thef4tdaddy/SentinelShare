...
def upgrade() -> None:
    ...
    with op.batch_alter_table('manualrule', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('is_shadow_mode', sa.Boolean(), nullable=False, server_default=sa.text('false')))
        batch_op.add_column(sa.Column('match_count', sa.Integer(), nullable=False, server_default='0'))

    with op.batch_alter_table('processedemail', schema=None) as batch_op:
        batch_op.add_column(sa.Column('encrypted_body', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
        batch_op.add_column(sa.Column('encrypted_html', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
